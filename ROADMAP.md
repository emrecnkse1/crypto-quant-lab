...
- **Faz 6:** Validation / anti-overfitting — **Kısmen tamamlandı** (ayrıntı: `VALIDATION_SPEC.md` §22.2)
  ...
  - FAZ6C (advanced overfitting controls): Tamamlanmadı — purging/embargo, trial-group, Deflated Sharpe, trial return matrix, PBO/CSCV, Holm düzeltme temeli ve CPCV fold modeli, train-seçimli CPCV path getirileri ve betimsel path dağılımı özeti (2026-09-25; yalnız offline teşhis) tamamlandı; CPCV'nin kalanı (label/outcome-horizon purging — öneri VALIDATION_SPEC §17.2.25), geçerli p-değeri üretimi / aile kapsamı / seçim politikası, parameter stability, efektif-N, çok pencereli DSR ve PBO yan istatistikleri açık
