...
- **Faz 7:** İlk Funding/Basis araştırması — **Başladı; ilk üç dikey dilim tamamlandı, Faz 7 bütünü tamamlanmadı** (ayrıntı: `FUNDING_RESEARCH_SPEC.md`)
  ...
  - Çok bacaklı muhasebe/execution: kodla eşleştirilmiş TASLAK (DRAFT, FUNDING_RESEARCH_SPEC §19); ilk muhasebe dilimi IMPLEMENTED + TESTED (aşağıda, §19.10.1); replay/event scheduling NOT IMPLEMENTED — sözleşme taslağı §19.12 (DRAFT); geri kalan tasarım ve K1–K7 / R1–R5 kararları açık
